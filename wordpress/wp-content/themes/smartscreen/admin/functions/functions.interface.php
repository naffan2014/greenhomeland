...
function optionsframework_add_admin() {
    ...
    $sidehook = add_theme_page('Sidebars', 'Sidebars', 'edit_theme_options', 'sidebars', 'hight_sidebars');
    ...
    add_action('admin_print_styles', 'of_style_only');
...
function of_load_only() 
{
	...
	wp_enqueue_script('ht_general', ADMIN_DIR .'assets/js/general.js', array( 'jquery' ));
}


function ht_admin_scripts() {

        wp_enqueue_script( 'custom-js', ADMIN_DIR .'assets/js/custom.js', array('jquery'));

}

add_action('admin_print_scripts', 'ht_admin_scripts');
/**
