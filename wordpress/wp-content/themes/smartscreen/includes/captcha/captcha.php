...
function captcha($config = array()) {
	...
	$captcha_config = array(
		...
		'fonts' => array(dirname(__FILE__) . '/Underdog_Regular.ttf'),
    ...
    //$image_src = substr(__FILE__, strlen(rtrim($_SERVER['DOCUMENT_ROOT'],"/"))) . '?_CAPTCHA&amp;t=' . urlencode(microtime());
    $image_src = get_template_directory_uri(). "/includes/captcha/captcha.php?".  '_CAPTCHA&amp;t=' . urlencode(microtime());
